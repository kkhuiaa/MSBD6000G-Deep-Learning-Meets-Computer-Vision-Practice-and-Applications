...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        aff_out, aff_cache = affine_forward(crp_out, W2, b2)
        relu_out, relu_cache = relu_forward(aff_out)
        aff_out2, aff_cache2 = affine_forward(relu_out, W3, b3)
        scores = np.copy(aff_out2)
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
        ...
        dx3, dw3, db3 = affine_backward(dsoft, aff_cache2)
        drelu = relu_backward(dx3, relu_cache)
        dx2, dw2, db2 = affine_backward(drelu, aff_cache)

        dx1, dw1, db1 = conv_relu_pool_backward(dx2, crp_cache)
